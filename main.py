...
app = FastAPI(title="Secure Multi Search API - Vercel Edition")
...
# 1️⃣ FIRST ENDPOINT: Mobile Search
@app.get("/search")
...
# 2️⃣ SECOND ENDPOINT: Aadhaar Search
...
async def search_aadhaar(
    ...
    try:
        # Extended timeout to 25.0s for slow source responses
